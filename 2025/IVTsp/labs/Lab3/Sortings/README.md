...
* `very_small_tests` -- тесты с массивами размера от $1$ до $150$ с шагом $1$, ограничение MAX_RAND, тестов каждого размера $5$ штук;
...
*Принимается строго Bottom-Up версия пирамидальной сортировки, на семинарах уже сравнивались heapSort и Bottom-Up версии*
...
* Добавить к сравнению из пункта 7 Timsort+PDQSort(можно использовать любые готовые), за это $5$ баллов

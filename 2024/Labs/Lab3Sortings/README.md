...
## Пункт 9. Вывод (4 б., вывод может может получить полные 4 б. если реализованы все пункты, кроме опциональных)

Постройте график, в котором участвуют лучшие сортировки из пунктов .
